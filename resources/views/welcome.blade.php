        ...
        <section id="etaireia" class="py-16 sm:py-20 bg-white" aria-labelledby="etaireia-heading">
            <div class="mx-auto px-4 sm:px-6 lg:px-8" style="max-width: 1400px;">
                <div class="flex items-center gap-4" data-aos="fade-up">
                    <div class="flex h-10 w-10 sm:h-14 sm:w-14 shrink-0 items-center justify-center rounded-full bg-brand-magenta/10">
                        <svg class="h-5 w-5 sm:h-7 sm:w-7 text-brand-magenta" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                        </svg>
                    </div>
                    <div>
                        <h2 id="etaireia-heading" class="text-2xl sm:text-4xl font-bold text-brand-magenta">Η Εταιρεία</h2>
            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8" style="max-width: 1400px;">
                <div class="text-left md:text-center" data-aos="fade-up">
                    <div class="flex items-center gap-4 md:justify-center">
                        ...
                        <h2 id="kyd-heading" class="text-2xl sm:text-4xl font-bold" style="color: #c3057d;">Υπηρεσίες</h2>
                    </div>
                    ...
                    <div class="jobs-grid">
                        <div>
                            <div class="flex items-center gap-4">
                                ...
                                <h2 class="text-2xl sm:text-4xl font-bold" style="color: #c3057d; white-space: nowrap;">Θέσεις Εργασίας</h2>
                            </div>
                ...
                <div class="contact-grid" data-aos="fade-up" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0px 2px 70px 0px rgba(110, 130, 208, 0.18);">
                    ...
                    <div>
                        <div class="flex items-center gap-4">
                            ...
                            <h2 id="epikoinonia-heading" class="text-2xl sm:text-4xl font-bold" style="color: #c3057d;">Επικοινωνία</h2>
                        </div>

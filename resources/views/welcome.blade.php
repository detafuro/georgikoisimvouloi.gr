            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8" style="max-width: 1400px;">
                <div class="text-center" style="padding-bottom: 30px;" data-aos="fade-up">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <h2 id="kyd-heading" class="text-3xl sm:text-4xl font-bold" style="padding-bottom: 50px; color: #c3057d;">Υπηρεσίες</h2>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr auto; gap: 40px; align-items: center;">
                        <div>
                            <div class="flex items-center gap-4">
                                ...
                                <h2 class="text-3xl sm:text-4xl font-bold" style="color: #c3057d;">Θέσεις Εργασίας</h2>
                            </div>
                ...
                <div data-aos="fade-up" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0px 2px 70px 0px rgba(110, 130, 208, 0.18); display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start;">
                    ...
                    <div>
                        <div class="flex items-center gap-4">
                            ...
                            <h2 id="epikoinonia-heading" class="text-3xl sm:text-4xl font-bold" style="color: #c3057d;">Επικοινωνία</h2>
                        </div>
